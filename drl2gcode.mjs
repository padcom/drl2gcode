...
program
  ...
  .option('-f, --feedrate <rate>', 'Feed rate for drilling (default: 50)', 50)
  .option('-s, --spindle <speed>', 'Spindle speed (default: 400)', 400)
  .option('-j, --jog-z <z-height>', 'Z height for initial and final jogging (default: 15)', 15)
  .option('-m, --move-z <z-height>', 'Z height for jogging between points (default: 1)', 1)
  .option('-d, --depth <depth>', 'Drilling depth(default: 2.5)', 2.5)
  .action(convert)
  .parse(process.argv)
